  ...
  return (
    <section className="about-us-section" data-aos="fade-up" data-aos-duration="1000">
      <div className="about-us-content">
        <div className="about-us-main" data-aos="fade-up" data-aos-delay="200">
          <h2 className="about-us-heading">About Us</h2>
        </div>
        <div className="about-us-column" data-aos="fade-up" data-aos-delay="400">
        ...
        <div className="about-us-column" data-aos="fade-up" data-aos-delay="600">
          <p className="about-us-paragraph">
